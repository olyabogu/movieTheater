...
ALTER TABLE USER_TICKET_MP ADD CONSTRAINT FK_USER_TICKET_MP1 FOREIGN KEY(USER_ID) REFERENCES USER(ID);
ALTER TABLE USER_TICKET_MP ADD CONSTRAINT FK_USER_TICKET_MP2 FOREIGN KEY(TICKET_ID) REFERENCES TICKET(ID);
...
ALTER TABLE EVENT_DATE_MP ADD CONSTRAINT FK_EVENT_DATE_MP1 FOREIGN KEY(EVENT_ID) REFERENCES EVENT(ID);
...
ALTER TABLE EVENT_TICKET_MP ADD CONSTRAINT FK_EVENT_TICKET_MP1 FOREIGN KEY(EVENT_ID) REFERENCES EVENT(ID);
ALTER TABLE EVENT_TICKET_MP ADD CONSTRAINT FK_EVENT_TICKET_MP2 FOREIGN KEY(TICKET_ID) REFERENCES TICKET(ID);
...
ALTER TABLE EVENT_BY_NAME ADD CONSTRAINT FK_EVENT_BY_NAME1 FOREIGN KEY(EVENT_ID) REFERENCES EVENT(ID);
...
ALTER TABLE EVENT_BY_PRICE ADD CONSTRAINT FK_EVENT_BY_PRICE1 FOREIGN KEY(EVENT_ID) REFERENCES EVENT(ID);
...
ALTER TABLE USER_DISCOUNT ADD CONSTRAINT FK_USER_DISCOUNT1 FOREIGN KEY(USER_ID) REFERENCES USER(ID);
...
ALTER TABLE USER ADD CONSTRAINT FK_USER1 FOREIGN KEY (USER_ACCOUNT_ID) REFERENCES USER_ACCOUNT(ID);
